...
print("MA Config    ", ma_short,",", ma_medium)
...
fig.add_annotation(text=
                "MA Config       " + str(ma_short) + "," + str(ma_medium) + '<br>' +
...
plotly.offline.plot(fig, filename = 'ResultsDoubleMA.html', auto_open=False, config=dict(displayModeBar=True, scrollZoom = True))