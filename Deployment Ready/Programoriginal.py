...
if df.iloc[bar_offset, 4] >= df.iloc[bar_offset, 6] and df.iloc[bar_offset,4] <= df.iloc[bar_offset,5] and df.iloc[bar_offset, 9] >= df.iloc[bar_offset, 10] and side == 'SELL':
    if debug == False:
        if firstbet == False:
            try:
...
elif df.iloc[bar_offset, 4] <= df.iloc[bar_offset, 6] and df.iloc[bar_offset,4] >= df.iloc[bar_offset,5] and df.iloc[bar_offset, 9] <= df.iloc[bar_offset, 10] and side == 'BUY':
    if debug == False:
        if firstbet == False:
            try:
                order = client.futures_create_order(
